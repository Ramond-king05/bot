...
Introduce_Ans = ["My name is AIBot.","My name is AIBot you can called me Ai.","Im AIBot :) ","My name is PyBot. and my nickname is pibot and i am happy to solve your queries :) "]
GREETING_INPUTS = ("hello", "hi","hiii","hii","whatsup","salute you", "greetings", "sup", "what's up","hey")
